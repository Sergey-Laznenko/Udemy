//! Function это блок кода, который можно выполнять многократно, функции помогают оптимизировать код, посредством написания функций, которые помогают избегать одинаковых блоков кода
...
increasePersonAge(personOne)  // вызываем объявленную функцию и передаём аргументом ссылку, хранящуюся в значениее переменной personOne
